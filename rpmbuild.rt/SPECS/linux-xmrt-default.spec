...
Requires: linux-xmrt-default-license = %{version}-%{release}
...
Group:          kernel
Requires:       linux-xmrt-default = %{version}-%{release}
Requires:       linux-xmrt-default-extra = %{version}-%{release}
Requires:       linux-xmrt-default-license = %{version}-%{release}
...
mkdir -p %{buildroot}/usr/share/package-licenses/linux-xmrt-default
cp COPYING %{buildroot}/usr/share/package-licenses/linux-xmrt-default/COPYING
cp -a LICENSES/* %{buildroot}/usr/share/package-licenses/linux-xmrt-default
...
/usr/share/package-licenses/linux-xmrt-default
