...
%define ktarget  xmrt-preempt_rt
...
Requires: linux-xmrt-preempt_rt-license = %{version}-%{release}
...
Group:          kernel
Requires:       linux-xmrt-preempt_rt = %{version}-%{release}
Requires:       linux-xmrt-preempt_rt-extra = %{version}-%{release}
Requires:       linux-xmrt-preempt_rt-license = %{version}-%{release}
...
mkdir -p %{buildroot}/usr/share/package-licenses/linux-xmrt-preempt_rt
cp COPYING %{buildroot}/usr/share/package-licenses/linux-xmrt-preempt_rt/COPYING
cp -a LICENSES/* %{buildroot}/usr/share/package-licenses/linux-xmrt-preempt_rt
...
/usr/share/package-licenses/linux-xmrt-preempt_rt
