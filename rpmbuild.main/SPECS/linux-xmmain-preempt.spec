...
Summary:        The Linux kernel
Group:          kernel
Requires:       linux-xmmain-preempt = %{version}-%{release}
Requires:       linux-xmmain-preempt-extra = %{version}-%{release}
Requires:       linux-xmmain-preempt-license = %{version}-%{release}
...
mkdir -p %{buildroot}/usr/share/package-licenses/linux-xmmain-preempt
cp COPYING %{buildroot}/usr/share/package-licenses/linux-xmmain-preempt/COPYING
cp -a LICENSES/* %{buildroot}/usr/share/package-licenses/linux-xmmain-preempt
...
/usr/share/package-licenses/linux-xmmain-preempt
