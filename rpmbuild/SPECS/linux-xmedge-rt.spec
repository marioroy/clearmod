...
Requires: linux-xmedge-rt-license = %{version}-%{release}
...
Summary:        The Linux kernel
Group:          kernel
Requires:       linux-xmedge-rt = %{version}-%{release}
Requires:       linux-xmedge-rt-extra = %{version}-%{release}
Requires:       linux-xmedge-rt-license = %{version}-%{release}
...
mkdir -p %{buildroot}/usr/share/package-licenses/linux-xmedge-rt
cp COPYING %{buildroot}/usr/share/package-licenses/linux-xmedge-rt/COPYING
cp -a LICENSES/* %{buildroot}/usr/share/package-licenses/linux-xmedge-rt
...
/usr/share/package-licenses/linux-xmedge-rt
