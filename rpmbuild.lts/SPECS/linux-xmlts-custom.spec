...
Requires: linux-xmlts-custom-license = %{version}-%{release}
...
Summary:        The Linux kernel
Group:          kernel
Requires:       linux-xmlts-custom = %{version}-%{release}
Requires:       linux-xmlts-custom-extra = %{version}-%{release}
Requires:       linux-xmlts-custom-license = %{version}-%{release}
...
mkdir -p %{buildroot}/usr/share/package-licenses/linux-xmlts-custom
cp COPYING %{buildroot}/usr/share/package-licenses/linux-xmlts-custom/COPYING
cp -a LICENSES/* %{buildroot}/usr/share/package-licenses/linux-xmlts-custom
...
/usr/share/package-licenses/linux-xmlts-custom
