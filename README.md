...
* org.clearlinux.xmbore.6.9.2-181
  org.clearlinux.xmclear.6.9.2-181

XM installed packages (excluding dev,extra,license)
* linux-xmbore-6.9.2-181
  linux-xmclear-6.9.2-181
```
...
```bash
./xm-uninstall clear 181
Removing org.clearlinux.xmclear.6.9.2-181
```
