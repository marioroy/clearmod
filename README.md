...
XanMod boot-manager entries
  org.clearlinux.xmedge-preempt.6.7.5-142
* org.clearlinux.xmmain-preempt.6.6.17-142

XanMod installed packages, exluding dev,extra,license
  linux-xmedge-preempt-6.7.5-142
* linux-xmmain-preempt-6.6.17-142
```
...
```bash
./xm-uninstall edge-preempt 142
Removing org.clearlinux.xmedge-preempt.6.7.5-142
```
