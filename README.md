...
* org.clearlinux.xmbore.6.9.3-182
  org.clearlinux.xmclear.6.9.3-182

XM installed packages (excluding dev,extra,license)
* linux-xmbore-6.9.3-182
  linux-xmclear-6.9.3-182
```
...
```bash
./xm-uninstall clear 182
Removing org.clearlinux.xmclear.6.9.3-182
```
