...
* org.clearlinux.xmbore.6.10.2-191
  org.clearlinux.xmclear.6.10.2-191

XM installed packages (excluding dev,extra,license)
* linux-xmbore-6.10.2-191
  linux-xmclear-6.10.2-191
```
...
```bash
./xm-uninstall clear 191
Removing org.clearlinux.xmclear.6.10.2-191
```
