...
* org.clearlinux.xmbore.6.10.8-195
  org.clearlinux.xmclear.6.10.8-195

XM installed packages (excluding dev,extra,license)
* linux-xmbore-6.10.8-195
  linux-xmclear-6.10.8-195
```
...
```bash
./xm-uninstall clear 195
Removing org.clearlinux.xmclear.6.10.8-195
```
